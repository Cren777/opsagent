...
app.include_router(config.router, tags=["配置管理"], dependencies=[Depends(get_current_user)])
app.include_router(uploads.router, dependencies=[Depends(get_current_user)])
...
app.include_router(diagnostics.router, dependencies=[Depends(get_current_user)])
app.include_router(indexes.router, dependencies=[Depends(get_current_user)])
